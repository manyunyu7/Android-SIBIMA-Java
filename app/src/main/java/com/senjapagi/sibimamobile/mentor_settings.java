...
public class mentor_settings extends AppCompatActivity {
...
//                    EtUpdateline.setError("Lengkapi Data Terlebih Dahulu");
        ...
        findViewById(R.id.btn_home).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mentor_settings.super.onBackPressed();
            }
        });
    }
    ...
    private void updateData(){
        findViewById(R.id.animation_lootie_loading).setVisibility(View.VISIBLE); //SHOWING LOADING INDICATOR
        AndroidNetworking.post(CLIENT_API.updateBasicMentor)
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            if(response.getJSONArray("update_status").getJSONObject(0).getString("status_update").equals("berhasil")){
                                Toast.makeText(mentor_settings.this, "Berhasil Update Data", Toast.LENGTH_SHORT).show();
                                ...
                                Toast.makeText(mentor_settings.this, "Gagal Update Data", Toast.LENGTH_SHORT).show();
                            }

                        } catch (JSONException e) {
                            e.printStackTrace();
                            Toast.makeText(mentor_settings.this, "Gagal Mengupdate Data / Failed", Toast.LENGTH_SHORT).show();
                            Toast.makeText(mentor_settings.this, e.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onError(ANError anError) {
                        findViewById(R.id.animation_lootie_loading).setVisibility(View.GONE); //HIDING LOADING INDICATOR
                        Toast.makeText(mentor_settings.this, "Gagal Update Data, Connection Unstable Try Again Later", Toast.LENGTH_SHORT).show();
                        Toast.makeText(mentor_settings.this, anError.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
    private void updatePassword(){
        ...
        if(password.equals(newPassword)){
            ...
            if(etNewPassword.getText().toString().length()<6)
                ...
                findViewById(R.id.animation_lootie_loading).setVisibility(View.VISIBLE); //SHOWING LOADING INDICATOR
                AndroidNetworking.post(CLIENT_API.updatePasswordMentor)
                        .addBodyParameter("nim", getIntent().getStringExtra(ConstantMentee.nim))
                                ...
                                try {
                                    ...
                                    if(status.equals("berhasil")){
                                        ...
                                        a.postDelayed(new Runnable() {
                                            @Override
                                            public void run() {
                                                Intent a = new Intent(mentor_settings.this,MainActivity.class);
                                                Toast.makeText(mentor_settings.this, "Silahkan Login Kembali", Toast.LENGTH_SHORT).show();
                                                startActivity(a);
                                            }
                                        },1000);
                                    }else{
                                        Toast.makeText(mentor_settings.this, "Update Password Gagal/Failed", Toast.LENGTH_SHORT).show();
                                    }
                                } catch (JSONException e) {
                                    e.printStackTrace();
                                    Toast.makeText(mentor_settings.this, e.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                                    Toast.makeText(mentor_settings.this, "Gagal Mengupdate Password / Failed", Toast.LENGTH_SHORT).show();
                                }
                            }
    ...
    private void getBeforeData(){
        findViewById(R.id.animation_lootie_loading).setVisibility(View.VISIBLE); //SHOWING LOADING INDICATOR
        AndroidNetworking.post(CLIENT_API.getBasicMentor)
                .addBodyParameter("nim",getIntent().getStringExtra(ConstantMentee.nim))
                .setPriority(Priority.HIGH)
                .build()
                .getAsJSONObject(new JSONObjectRequestListener() {
...
//                            jurusan.setText(response.getJSONArray("before").getJSONObject(0).getString("jurusan"));
                            ...
                            EtUpdateline.setText(line);
                            tvCurrentMenteePhone.setText(kontak);
                            EtUpdatekontak.setText(kontak);
                    ...
                    public void onError(ANError anError) {
                        findViewById(R.id.animation_lootie_loading).setVisibility(View.GONE); //HIDING LOADING INDICATOR
                        Toast.makeText(mentor_settings.this, "Connection Unstable Try Again Later", Toast.LENGTH_SHORT).show();
                    }
                });
    }
