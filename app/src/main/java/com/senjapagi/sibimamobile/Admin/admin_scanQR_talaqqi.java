package com.senjapagi.sibimamobile.Admin;
...
public class admin_scanQR_talaqqi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_scan_qr_talaqqi);
        ...
        mCodeScanner.setDecodeCallback(new DecodeCallback() {
            ...
            public void onDecoded(@NonNull final Result result) {
                ...
                admin_scanQR_talaqqi.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
    ...
    private void dialogCheckPermission() {
        if (ContextCompat.checkSelfPermission(getApplicationContext(), android.Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(admin_scanQR_talaqqi.this, new String[]{android.Manifest.permission.CAMERA}, 50);
    ...
    private void getAgenda() {
        ...
        AndroidNetworking.post(CLIENT_API.getAgendaTalaqqi)
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            if (response.getJSONArray("agenda").length() == 0) {
                                Toast.makeText(admin_scanQR_talaqqi.this, "Belum Ada Agenda", Toast.LENGTH_SHORT).show();
                                ArrayAdapter<String> adp1 = new ArrayAdapter<String>
                                        (admin_scanQR_talaqqi.this, android.R.layout.simple_list_item_1, list);
                                ...
                                Toast.makeText(admin_scanQR_talaqqi.this, "Panjang Array List : " + list.size(), Toast.LENGTH_SHORT).show();
                            }
                    ...
                    public void onError(ANError anError) {
                        findViewById(R.id.animation_lootie_loading).setVisibility(View.INVISIBLE);
                        Toast.makeText(admin_scanQR_talaqqi.this, anError.getMessage(), Toast.LENGTH_LONG).show();
                        mCodeScanner.stopPreview();
                        Toast.makeText(admin_scanQR_talaqqi.this, "Periksa Koneksi Internet Anda, Silakan Coba Lagi Nanti", Toast.LENGTH_LONG).show();
                        Handler a = new Handler();
                        a.postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                admin_scanQR_talaqqi.super.onBackPressed();
                            }
                        },700);
                    }
                });
    ...
    private void scanPeserta(String mentee_id,String agenda_id){
        AndroidNetworking.post(CLIENT_API.insertPresensiTalaqqi)
                .setPriority(Priority.HIGH)
                .addBodyParameter("mentor_id",mentee_id)
    ...
    private void scanned(String result){
        if(agenda.getText().toString().equals("PILIH AGENDA")){
            ...
            try {
                MediaPlayer.create(admin_scanQR_talaqqi.this, R.raw.beep).start();
//                              String idAgenda = dataScan.substring(dataScan.indexOf("("),dataScan.indexOf(")"));
//                              String idAgenda = "";
//                              String idAgenda = dataScan.split("[\\(\\)]")[1];
                Toast.makeText(admin_scanQR_talaqqi.this, agenda.getText().toString(), Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(admin_scanQR_talaqqi.this, "ID MENTEE : "+idMentee, Toast.LENGTH_SHORT).show();
                Toast.makeText(admin_scanQR_talaqqi.this, "ID AGENDA : "+idAgenda, Toast.LENGTH_SHORT).show();
                scanPeserta(idMentee,idAgenda);

            }catch (Exception x){
                Toast.makeText(admin_scanQR_talaqqi.this, agenda.getText().toString(), Toast.LENGTH_SHORT).show();
                Toast.makeText(admin_scanQR_talaqqi.this, "ERROR RESULT :\n"+x.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
            }
        }
    }

    private void success() {
        MediaPlayer.create(admin_scanQR_talaqqi.this, R.raw.success).start();
    ...
    private void error(String errorType){
        MediaPlayer.create(admin_scanQR_talaqqi.this, R.raw.error).start();
        String message ="";
